...
public class QuoteSaxHandler extends DefaultHandler {
    ...
    private Quote quoteTmp = null; // temporary quotes.Quote
    ...
    /*added on 3/3/2018 by Ranjit. To add <category> element from xml*/
    private final String QuoteCategoryElem = "category";
    ...
    public void startElement(String uri, String name, String qName, Attributes atts) {
         ...
         * Set current element based on category matching*/
        else if (qName.equalsIgnoreCase(QuoteCategoryElem)) {
            currentElement = QuoteCategoryElem;
        }
    }
    ...
    public void characters(char ch[], int start, int length) {
        ...
        if (!value.trim().equals("")) {
            ...
            /*added on 3/3/2018 by Ranjit. To add category to the quote*/
            else if (currentElement.equalsIgnoreCase(QuoteCategoryElem)) {
                quoteTmp.setCategory(value);
            }
        }
    }
